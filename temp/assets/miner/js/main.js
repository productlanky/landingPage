    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                logoinner.attr('src', '../../../temp/images/logo.png');
                logodefault.attr('src', '../../../temp/images/logo.png');
                logowhite.attr('src', '../../../temp/images/logo.png');
                logowhitedark.attr('src', '../../../temp/images/logo.png');
                logo2.attr('src', '../../../temp/images/logo.png');
                logo3.attr('src', '../../../temp/images/logo.png');
            }
            else {
                $("header").removeClass("fixedHeader").addClass("scrollHeader");
                logoinner.attr('src', '../../../temp/images/logo-dark.png');
                logodefault.attr('src', '../../../temp/images/logo-dark.png');
                logowhite.attr('src', '../../../temp/images/logo-dark.png');
                logowhitedark.attr('src', '../../../temp/images/logo-dark.png');
                logo2.attr('src', '../../../temp/images/logo-dark.png');
                logo3.attr('src', '../../../temp/images/logo-dark.png');
            }
        });
